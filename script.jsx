...
function Sliders2(props) {
    ...
    return (
        <span className="sliders2">
            X:&nbsp;
            <input type="range" min={min1} max={max1} value={props.value1}
                onChange={props.onChange1}
                disabled={disabled1}
                />
            <input type="text" value={props.value1}
                onChange={props.onChange1}
            ...
            <br/>
            Y:&nbsp;
            <input type="range" min={min2} max={max2} value={props.value2}
                onChange={props.onChange2}
                disabled={disabled2}
                />
            <input type="text" value={props.value2}
                onChange={props.onChange2}
...
function Sliders4(props) {
    ...
    return (
        <span className="sliders4">
            ...
            <br/>
            U:&nbsp;
            <input type="range" min={min3} max={max3} value={props.value3}
                onChange={props.onChange3}
                disabled={disabled3}
                />
            <input type="text" value={props.value3}
                onChange={props.onChange3}
            ...
            <br/>
            D:&nbsp;
            <input type="range" min={min4} max={max4} value={props.value4}
                onChange={props.onChange4}
                disabled={disabled4}
                />
            <input type="text" value={props.value4}
                onChange={props.onChange4}
            ...
            <div>
                ...
                <form className="form">
                    <fieldset>
                        ...
                        <Sliders2 min1={minWhile(max_input_size.X, 1, (x) => paramsOK({X: x, Y: input_size.Y}, weight_size, padding, dilation, stride))}
                                    max1={max_input_size.X}
                                    value1={input_size.X}
                                    onChange1={onChangeInner("input_size", "X")}
                                    min2={minWhile(max_input_size.Y, 1, (x) => paramsOK({X: input_size.X, Y: x}, weight_size, padding, dilation, stride))}
                    ...
                    <fieldset>
                        ...
                        <Sliders2 min1="1"
                                    max1={maxWhile(1, 100, (x) => paramsOK(input_size, {X: x, Y: weight_size.Y}, padding, dilation, stride))}
                                    value1={weight_size.X}
                                    onChange1={onChangeInner("weight_size", "X")}
                                    min2="1"
                                    max2={maxWhile(1, 100, (x) => paramsOK(input_size, {X: weight_size.X, Y: x}, padding, dilation, stride))}
                    ...
                    <fieldset>
                        ...
                        <Sliders4 min1={minWhile(dilation.X*(weight_size.X-1), 0, (x) => paramsOK(input_size, weight_size, {L: x, R: padding.R, U: padding.U, D: padding.D}, dilation, stride))}
                                    max1={Math.max(dilation.X*(weight_size.X-1), dilation.X*(weight_size.X-1))}
                                    value1={padding.L}
                                    onChange1={onChangeInner("padding", "L")}
                                    min2={minWhile(dilation.X*(weight_size.X-1), 0, (x) => paramsOK(input_size, weight_size, {L: padding.L, R: x, U: padding.U, D: padding.D}, dilation, stride))}
                                    max2={Math.max(dilation.X*(weight_size.X-1), dilation.X*(weight_size.X-1))}
                                    value2={padding.R}
                                    onChange2={onChangeInner("padding", "R")}
                                    min3={minWhile(dilation.Y*(weight_size.Y-1), 0, (x) => paramsOK(input_size, weight_size, {L: padding.L, R: padding.R, U: x, D: padding.D}, dilation, stride))}
                                    max3={Math.max(dilation.Y*(weight_size.Y-1), dilation.Y*(weight_size.Y-1))}
                                    value3={padding.U}
                                    onChange3={onChangeInner("padding", "U")}
                                    min4={minWhile(dilation.Y*(weight_size.Y-1), 0, (x) => paramsOK(input_size, weight_size, {L: padding.L, R: padding.R, U: padding.U, D: x}, dilation, stride))}
                    ...
                    <fieldset>
                        ...
                        <Sliders2 min1="1"
                                    max1={maxWhile(1, 100, (x) => paramsOK(input_size, weight_size, padding, {X: x, Y: dilation.Y}, stride))}
                                    value1={dilation.X}
                                    onChange1={onChangeInner("dilation", "X")}
                                    disabled1={weight_size.X === 1}
                                    min2="1"
                                    max2={maxWhile(1, 100, (x) => paramsOK(input_size, weight_size, padding, {X: dilation.X, Y: x}, stride))}
                                    value2={dilation.Y}
    ...
    render() {
        ...
        function compute_input_multiplies_with_weight(hoverH, hoverW) {
            ...
            for (let h_weight = 0; h_weight < weight_size.Y; h_weight++) {
                for (let w_weight = 0; w_weight < weight_size.X; w_weight++) {
                    ...
                    if (typeof flat_input === "undefined") 
                        continue;
        ...
        return (
            <div className="viewport">
                ...
                Input ({input_size.X} × {input_size.Y}):
                <Grid size={{X: input_size.X + padding. L + padding.R, Y: input_size.Y + padding.U + padding.D}}
                ...
                <div className="grid-container">
                Weight ({weight_size.X} × {weight_size.Y}):
                ...
                <div className="grid-container">
                Output ({output_size.X} × {output_size.Y}):
